...
// Description: Implementation AppDelegate class used for state transitions when views
//              are switched
...
// Default function called when application is loaded
    
    self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    // Override point for customization after application launch.
    self.viewController = [[loginView alloc] initWithNibName:@"edu_psuViewController" 
                                                      bundle:nil];
...
// Default function called when application enters the background
    
    // Post a notification to the notification center with the name "didEnterBackground"
